...
export function TemplateSelector({ selectedTemplateId, onSelect }: TemplateSelectorProps) {
  return (
    <section className="py-4 sm:py-6 lg:py-8">
      <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 sm:mb-5">{strings.template.title}</h2>
          ...
          return (
            ...
            >
              ...
              <div className="p-3 sm:p-3.5 bg-white">
                ...
                <p className="text-xs text-slate-500">{strings.template.dimensions}</p>
              </div>
            </button>
          );
        })}
